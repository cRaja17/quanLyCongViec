...
<body>
<c:if test="${ not empty IdMember }"><c:redirect url="/member/"/></c:if>
<c:if test="${ empty IdMember }">
	<div class="login">
		<div class="signup">
			<form:form action="/qlvc/member/auth/login" method="POST"
				modelAttribute="member">
				<h1 class="signup-heading">Thành viên đăng nhập</h1>
				<p>${ statusLogin }</p>
				<label for="phone-number" class="signup-label">Số điện thoại</label>
